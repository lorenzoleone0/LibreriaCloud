Per l'utilizzo del database (file: LibreriaDB.bacpac) (guida su come importare il DB in SQL Server Management Studio: https://www.geeksforgeeks.org/how-to-import-and-export-sql-server-database/).
